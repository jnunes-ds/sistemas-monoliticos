...
import InvoiceModel from "../infrastructure/repository/sequelize/models/invoice.model";
import InvoiceItemModel from "../infrastructure/repository/sequelize/models/invoice-item.model";
